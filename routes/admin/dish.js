...
*响应数据:
    {code:200,msg:"upload succ",filleName:"123456799-2346.jpg"}
*/
//引入multer中间件
...
/*
*POST /admin/dish
*请求参数:{title:"xxx",imgUrl:"xxx.jpg",price:xx,detail:"xx"categoryId:xx}
*添加一个新的菜品
*输出消息:
...
/**
 * DELECT   /admin/dish/:did
 * 根据指定的菜品编号删除该菜品
 * 输出数据:
 *  {code:200,msg:"dish deleted succ"}
 *  {cdoe:400,msg:"dish not exists"}
 */
